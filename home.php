...
<body class="animate">
    <div style="height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1504711434969-e33886168f5c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); background-size: cover; background-position: center; color: white;">
        <div class="animate">
            <h1 style="font-size: 3.5rem; margin: 0; font-weight: 800; letter-spacing: -1px; text-shadow: 2px 2px 10px rgba(0,0,0,0.5);" data-i18n="welcome">BIENVENUE</h1>
    ...
    <div class="container animate" style="margin-top: -60px; position: relative; z-index: 10;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px;">
            <a href="<?php echo (isset($_SESSION['user_id']) || isset($_SESSION['admin_id'])) ? (isset($_SESSION['admin_id']) ? 'admin_dashboard.php' : 'user_dashboard.php') : 'index.php'; ?>" class="glass-card animate" style="text-align: center; text-decoration: none; transition: transform 0.3s; cursor: pointer; display: block;">
                <div style="font-size: 3.5rem; margin-bottom: 20px;">📰</div>
                <h3 style="color: var(--primary-blue);" data-i18n="manage_journals">Gestion des Journaux</h3>
                <p style="color: #666; font-size: 14px;" data-i18n="manage_journals_desc">Enregistrement de tous les journaux hebdomadaires avec matricule précis.</p>
            </a>
            <a href="search.php" class="glass-card animate" style="text-align: center; animation-delay: 0.1s; text-decoration: none; transition: transform 0.3s; cursor: pointer; display: block;">
                ...
                <p style="color: #666; font-size: 14px;" data-i18n="quick_search_desc">Recherchez toutes les informations par matricule, éditeur ou date.</p>
            </a>
            <a href="statistiques.php" class="glass-card animate" style="text-align: center; animation-delay: 0.2s; text-decoration: none; transition: transform 0.3s; cursor: pointer; display: block;">
                <div style="font-size: 3.5rem; margin-bottom: 20px;">📊</div>
