...
<head>
    ...
    <title data-i18n="search">Recherche - CIDST Tsimbazaza</title>
    ...
    <div class="container animate">
        ...
        <form action="search.php" method="GET" style="display: flex; flex-wrap: wrap; gap: 15px; margin: 40px 0; background: var(--light-grey); padding: 25px; border-radius: 12px;">
            <div style="flex: 2; min-width: 250px;">
                ...
                <input type="text" name="q" value="<?php echo htmlspecialchars($q); ?>" placeholder="Rechercher..." style="width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 6px;">
            </div>
            ...
            <div style="display: flex; align-items: flex-end;">
                <button type="submit" class="btn btn-blue" style="padding: 12px 40px;" data-i18n="search_button">RECHERCHER</button>
            </div>
        </form>
                        ...
                        <?php if (count($journals) > 0): ?>
                            <?php foreach ($journals as $j): ?>
                                <tr>
                                    ...
                                    <td><span class="badge badge-blue-dark" data-i18n="status_arrived">Arrivé</span></td>
                                    <td>
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 60px; color: #13379cff; border: 2px dashed #ddd; border-radius: 12px;">
