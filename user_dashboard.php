...
$error = "";
    ...
    if (empty($matricule) || empty($partie) || empty($editeur) || empty($lieu_edition) || empty($date_edition) || empty($date_sortie) || empty($lieu_stockage)) {
...
<body class="animate">
    ...
    <div class="container animate">
        ...
        <p style="margin-bottom: 30px; opacity: 0.8;">
            <span data-i18n="hello">Bonjour</span>, <strong><?php echo $_SESSION['user_nom'] ?? 'Utilisateur'; ?></strong>
            <?php if (isset($_SESSION['user_fonction'])): ?>
                <br><small style="color: var(--primary-blue);"><?php echo htmlspecialchars($_SESSION['user_fonction']); ?></small>
            <?php endif; ?>
        </p>
        ...
        <div class="glass-card">
            ...
            <form action="" method="POST" enctype="multipart/form-data" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-top: 20px;">
                ...
                <div class="form-group">
                    ...
                    <select name="partie" id="partieSelect" onchange="updatePrice()" required>
                        <option value="">-</option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="prix" id="priceInput" step="0.01" readonly style="background: #f4f4f4;" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lieu_stockage" required>
                </div>
                <div class="form-group">
                    <label data-i18n="place_edition">Lieu d'édition:</label>
                    <input type="text" name="lieu_edition" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <textarea name="description" placeholder="Détails sur la partie..." style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1;"></textarea>
                </div>
                <div style="grid-column: 1 / -1; margin-top: 10px;">
                    <button type="submit" name="enregistrer_journal" class="btn btn-blue" style="width: 100%;" data-i18n="save_journal">ENREGISTRER LE JOURNAL</button>
                </div>
            </form>
        </div>
    </div>
